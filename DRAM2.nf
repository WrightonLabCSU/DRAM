    ...
    */
    if( params.annotate ){
        ...
        if( annotate_kegg == 1 ){
            ...
            formattedOutputChannels.concat(ch_kegg_formatted)
        }
        ...
        if (annotate_fegenie == 1){
            formattedOutputChannels.concat(ch_fegenie_formatted)
        }

        if (annotate_methyl == 1){
            formattedOutputChannels.concat(ch_methyl_formatted)
        }

        if (annotate_cant_hyd == 1){
            formattedOutputChannels.concat(ch_cant_hyd_formatted)
        }

        if (annotate_heme == 1){
            formattedOutputChannels.concat(ch_heme_formatted)
        }

        if (annotate_sulfur == 1){
            formattedOutputChannels.concat(ch_sulfur_formatted)
        }
