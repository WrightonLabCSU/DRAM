...
workflow {
    ...
    */   
    if( params.distill_topic != "" || params.distill_ecosystem != "" || params.distill_custom != "" )
    {
        ...
        DISTILL( ch_final_annots, database_names_list, ch_combined_distill_sheets, ch_rrna_sheet, ch_rrna_combined, ch_trna_sheet, ch_distill_xlsx_script, ch_distill_sql_script )
