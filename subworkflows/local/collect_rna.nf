...
workflow COLLECT_RNA {
    ...
    if (run_rrna_collect) {
        ...
        ch_rrna_sheet = RRNA_COLLECT.out.rrna_combined_out
        ch_rrna_combined = RRNA_COLLECT.out.rrna_collected_out
    } else {
    ...
    if (run_trna_collect) {
        ...
        ch_trna_sheet = TRNA_COLLECT.out.trna_combined_out
        ch_trna_combined = TRNA_COLLECT.out.trna_collected_out
    } else {
