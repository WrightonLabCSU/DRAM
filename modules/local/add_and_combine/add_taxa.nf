process ADD_TAXA {
    ...
    # Assuming 'user_genome' matches 'input_fasta' and 'classification' is the taxonomy information
    ...
    if 'taxonomy' not in combined_annotations.columns or combined_annotations['taxonomy'].isnull().all():
        ...
        merged_data = pd.merge(combined_annotations, ch_taxa_data, left_on="input_fasta", right_on="user_genome", how="left")
