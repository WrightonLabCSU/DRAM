process TREES {
    ...
    python update_annots_trees.py aligned_sequences.jplace trees/${tree_option}/nar_nxr-tree-mapping.tsv raw-annotations.tsv updated-annotations.tsv trees/${tree_option}/${tree_option}.refpkg/nar_nxr.tre
