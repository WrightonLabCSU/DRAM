process COMBINE_DISTILL {
    ...
    path( ch_distill_carbon, stageAs:  "?/*")
    path( ch_distill_energy, stageAs:  "?/*") )
    path( ch_distill_misc, stageAs:  "?/*") )
    path( ch_distill_nitrogen, stageAs:  "?/*") )
    path( ch_distill_transport, stageAs:  "?/*") )
    path( ch_distill_ag, stageAs:  "?/*") )
    path( ch_distill_eng_sys, stageAs:  "?/*"))
    path( ch_distill_custom, stageAs:  "?/*") )
