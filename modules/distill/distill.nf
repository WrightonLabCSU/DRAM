process DISTILL {
    ...
    python ${ch_distill_xlsx_script} --target_id_counts ${ch_target_id_counts} --db_name annotations.db --distill_sheets ${distill_sheets} --rrna_file ${rrna_sheet} --trna_file ${trna_sheet} --output_file "distillate.xlsx"
