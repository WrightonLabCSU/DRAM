process MMSEQS_SEARCH {
   // not for use with PFAM
    ...
    mmseqs filterdb --filter-column 2 --comparison-operator ge --comparison-value ${bitScoreThreshold} --threads ${params.threads} 
    mmseqs_out/${sample}_${db_name}_tophit.mmsdb mmseqs_out/${sample}_${db_name}_tophit_minbitscore${bitScoreThreshold}.mmsdb

    # Convert results to BLAST outformat 6
    mmseqs convertalis query_database/* mmseqs_database/* mmseqs_out/${sample}_${db_name}_tophit_minbitscore${bitScoreThreshold}.mmsdb 
