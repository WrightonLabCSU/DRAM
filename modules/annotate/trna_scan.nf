process TRNA_SCAN {
    ...
    awk '!seen[\$3,\$4]++ {print \$1, \$2, \$5, \$6, \$9}' ${sample}_trna_out.txt > ${sample}_processed_trnas_temp.tsv
    ...
    paste ${sample}_processed_trnas_temp.tsv ${sample}_score_column.txt > ${sample}_processed_trnas_temp2.tsv

    # Add header
    echo -e "Name\ttRNA #\tType\tCodon\tBegin\tEnd\tScore" > ${sample}_processed_trnas.tsv
    cat ${sample}_processed_trnas_temp2.tsv >> ${sample}_processed_trnas.tsv
    """
