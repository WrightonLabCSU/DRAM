...
def distill_summary(combined_annotations_path, distill_sheets_file, output_path):
    ...
    for distill_sheet in distill_sheets:
        ...
        # Find the common gene_id column
        common_gene_id_column = [col for col in combined_annotations_df.columns if col.endswith("_id") and col != "query_id"]
        ...
        merged_df = pd.merge(combined_annotations_df, distill_df, left_on=common_gene_id_column[0], right_on=common_gene_id_column[0], how='inner')
