...
def main():
    ...
    ch_dbcan_fam = pd.read_csv(args.fam, sep="\t", comment='#', header=None, names=['target_id', 'subfamily'], engine='python', error_bad_lines=False, delimiter="\t", usecols=[0, 1], quoting=3)
